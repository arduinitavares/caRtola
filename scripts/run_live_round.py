...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--footystats-mode", choices=("none", "ppg", "ppg_xg"), default="ppg_xg")
...
def _print_success(console: Console, metadata: dict[str, object]) -> None:
    ...
    table.add_row("Fixture mode", str(metadata.get("fixture_mode")))
    table.add_row("Matchup context", str(metadata.get("matchup_context_mode")))
